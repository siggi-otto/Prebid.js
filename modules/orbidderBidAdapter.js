...
export const spec = {
     ...
     *
     * @param validBidRequests A non-empty list of valid bid requests that should be sent to the orbidder /bid endpoint,
     * i.e. the server.
     * @param bidderRequest The bidRequest object, containing request related information like gdpr consent
